    ...
    */
    const translations = {
        de: {
            ...
            servicesLead: 'In der kostenlosen Beratung schauen wir auf Beweglichkeit, Haltung, Kontrolle und deinen realistischen nächsten Schritt.',
            servicesCta: 'Beratung anfragen',
            mobilityServicesTitle: 'Mobility-Fokus',
            serviceMobilityCheckTitle: 'Mobility Check',
            serviceMobilityCheckText: 'Bewegungsfreiheit und sinnvolle nächste Schritte.',
            servicePostureTitle: 'Posture & Flexibility',
            servicePostureText: 'Haltung, Beweglichkeit und Körperkontrolle.',
            serviceRestartTitle: 'Return to Training',
            serviceRestartText: 'Wiedereinstieg mit Struktur und Ruhe.',
            consultationTopicsTitle: 'Themen der Beratung',
            serviceTrainingTitle: 'Training',
            serviceTrainingText: 'Welche Trainingsform passt zu Level und Alltag?',
            serviceOnlineTitle: 'Online Coaching',
            serviceOnlineText: 'Ob flexible Online-Begleitung sinnvoll ist.',
            serviceNutritionTitle: 'Nutrition Habits',
            serviceNutritionText: 'Einfache Gewohnheiten, die Training unterstützen.',
        ...
        en: {
            ...
            servicesLead: 'In the free consultation, we look at mobility, posture, control, and your realistic next step.',
            servicesCta: 'Request consultation',
            mobilityServicesTitle: 'Mobility focus',
            serviceMobilityCheckTitle: 'Mobility Check',
            serviceMobilityCheckText: 'Freedom of movement and useful next steps.',
            servicePostureTitle: 'Posture & Flexibility',
            servicePostureText: 'Posture, flexibility, and body control.',
            serviceRestartTitle: 'Return to Training',
            serviceRestartText: 'A structured, calm restart after a break.',
            consultationTopicsTitle: 'Consultation topics',
            serviceTrainingTitle: 'Training',
            serviceTrainingText: 'Which training style fits your level and routine?',
            serviceOnlineTitle: 'Online Coaching',
            serviceOnlineText: 'Whether flexible online support makes sense.',
            serviceNutritionTitle: 'Nutrition Habits',
            serviceNutritionText: 'Simple habits that support your training.',
